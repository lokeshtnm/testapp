...
- (NSString *)loadVimeoAccessToken {
    return [[NSUserDefaults standardUserDefaults]objectForKey:@"LIAccessHTTPBody"];
}
- (void)storeVimeoAccessToken:(NSString *)accessToken {
    [[NSUserDefaults standardUserDefaults]setObject:accessToken forKey:@"LIAccessHTTPBody"];
}
@end
